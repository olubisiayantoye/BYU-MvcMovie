...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(MovieGenreViewModel model)
        {
            ...
            {
                movies = movies.Where(s => s.Title!.ToUpper().Contains(model.SearchString.ToUpper()));
            }
            ...
            // Filter by year
            if (model.SearchYear.HasValue)
            {
                movies = movies.Where(m => m.ReleaseDate.Year >= model.SearchYear.Value);
            }
